...
exports.fancyRadio = exports.radio = void 0;
var tailwind_variants_1 = require("tailwind-variants");
exports.radio = (0, tailwind_variants_1.tv)({
    slots: {
        ...
        indicator: "relative size-full before:shadow before:shadow-gray-950/25 before:absolute before:inset-0 before:m-auto before:transition before:duration-150 before:size-2 before:rounded-full before:bg-white",
    },
    variants: {
        intent: {
            primary: {
...
exports.fancyRadio = (0, tailwind_variants_1.tv)({
    extend: exports.radio,
    slots: {

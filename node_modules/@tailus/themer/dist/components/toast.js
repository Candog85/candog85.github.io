...
exports.toast = (0, tailwind_variants_1.tv)({
    slots: {
        ...
        viewport: "[--viewport-padding:_24px] fixed bottom-0 right-0 flex flex-col p-[var(--viewport-padding)] gap-2.5 w-[26rem] max-w-[100vw] m-0 list-none z-[2147483647] outline-none",
    },
    variants: {
        mixed: {
            true: {

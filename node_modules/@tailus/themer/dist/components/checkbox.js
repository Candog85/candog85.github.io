...
exports.fancyCheckbox = exports.checkbox = void 0;
var tailwind_variants_1 = require("tailwind-variants");
exports.checkbox = (0, tailwind_variants_1.tv)({
    ...
    variants: {
        intent: {
            ...
            secondary: "data-[state=checked]:bg-secondary-600 data-[state=indeterminate]:bg-secondary-600",
...
exports.fancyCheckbox = (0, tailwind_variants_1.tv)({
    extend: exports.checkbox,
    ...
    variants: {
        intent: {
            ...
            secondary: "data-[state=checked]:[--checkbox-border-color:theme(colors.secondary.600)] data-[state=indeterminate]:[--checkbox-border-color:theme(colors.secondary.600)]",

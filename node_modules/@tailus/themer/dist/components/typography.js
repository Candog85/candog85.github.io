...
exports.kbdTheme = exports.codeTheme = exports.title = exports.display = exports.link = exports.list = exports.text = exports.caption = exports.base = void 0;
var tailwind_variants_1 = require("tailwind-variants");
exports.base = (0, tailwind_variants_1.tv)({
    variants: {
        weight: {
            black: "font-black",
            bold: "font-bold",
...
exports.caption = (0, tailwind_variants_1.tv)({
    extend: exports.base,
...
exports.text = (0, tailwind_variants_1.tv)({
    extend: exports.base,
...
exports.list = (0, tailwind_variants_1.tv)({
    extend: exports.text,
...
exports.link = (0, tailwind_variants_1.tv)({
    extend: exports.base,
    base: "transition",
    variants: {
        size: {
        ...
        intent: {
            primary: "text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500",
            secondary: "text-secondary-600 hover:text-secondary-700 dark:text-secondary-400 dark:hover:text-secondary-500",
            ...
            success: "text-success-600 hover:text-success-700 dark:text-success-400 dark:hover:text-success-500",
            warning: "text-warning-700 hover:text-warning-600 dark:text-warning-400 dark:hover:text-warning-500",
            gray: "text-[--body-text-color]",
            neutral: "text-gray-950 hover:text-gray-800 dark:text-white dark:hover:text-gray-200",
        },
        variant: {
            plain: "",
            underlined: "underline",
            ghost: "hover:underline",
            animated: "relative before:absolute before:inset-x-0 before:bottom-0 before:h-px before:scale-x-0 before:origin-right hover:before:origin-left hover:before:scale-x-100 before:transition before:duration-200",
        },
        visited: {
...
exports.display = (0, tailwind_variants_1.tv)({
    extend: exports.base,
...
exports.title = (0, tailwind_variants_1.tv)({
    extend: exports.base,
...
exports.codeTheme = (0, tailwind_variants_1.tv)({
...
exports.kbdTheme = (0, tailwind_variants_1.tv)({

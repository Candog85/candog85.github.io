...
exports.accordion = exports.fancyBorder = void 0;
var tailwind_variants_1 = require("tailwind-variants");
exports.fancyBorder = "border dark:border-gray-950 !outline !outline-1 -outline-offset-2 !outline-white/5 dark:!outline-[--ui-border-color]";
exports.accordion = (0, tailwind_variants_1.tv)({
    slots: {
        root: "min-w-xs w-96",
        ...
        header: "flex",
        trigger: "group outline-none flex w-full items-center justify-between py-[--accordion-padding] text-[--title-text-color]",
        triggerIcon: "size-4 -mr-1 transition-transform duration-300 ease-[cubic-bezier(0.87,_0,_0.13,_1)] group-data-[state=open]:rotate-180 text-gray-600 dark:text-gray-400",
        triggerContent: "flex items-center gap-3",
        content: "overflow-hidden *:pb-[--accordion-padding] data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown text-[--body-text-color]",
    },
    variants: {
        variant: {
            default: {
    ...
    compoundVariants: [
        ...
        },
        {
            ...
            fancy: true,
            class: {
                item: "has-[:focus-visible]:outline has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-primary-600 ".concat(exports.fancyBorder),
            },
        },
    ],
    defaultVariants: {

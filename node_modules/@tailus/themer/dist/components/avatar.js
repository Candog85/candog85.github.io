...
exports.fallback = exports.soft = exports.solid = exports.avatar = exports.image = void 0;
var tailwind_variants_1 = require("tailwind-variants");
var status = "before:absolute before:z-[1] before:right-px before:size-2.5 before:rounded-full before:border-2 before:border-white dark:before:border-gray-950";
exports.image = (0, tailwind_variants_1.tv)({
    base: "size-full object-full rounded-[--avatar-radius]",
});
exports.avatar = (0, tailwind_variants_1.tv)({
    ...
    variants: {
        ...
        topStatus: {
            true: "".concat(status, " before:top-px"),
        },
        bottomStatus: {
            true: "".concat(status, " before:bottom-px"),
        },
    },
    compoundVariants: [
        {
